			...
			<div className="landing-page-container">
				...
				<div className="relative overflow-hidden rounded-[2.5rem] bg-slate-950 px-8 py-16 text-center shadow-2xl sm:px-16 sm:py-24 border border-white/5">
					...
					<div className="relative z-10 mx-auto max-w-3xl">
						...
						>
							Join 5,000+ students who use Pathwise to turn their
							skill confusion into a job-ready technical delta.
...
function FloatingPill({
	...
	color,
	...props
}: { text: string; color: string; delay: number } & React.CSSProperties) {
	return (
		<motion.div
		...
		>
			<div
				className={`rounded-full border ${color} bg-white/5 px-4 py-2 text-xs font-semibold backdrop-blur-md`}
			>
				{text}
			</div>
		</motion.div>
