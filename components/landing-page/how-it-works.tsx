...
const features = [
  {
    title: "Skill Audit",
    description: "Declare what you already know—skills, tools, projects, and experience.",
  ...
  },
  {
    ...
    description: "We compare your skills against real-time job requirements for your target role.",
  ...
  },
  {
    ...
    description: "Pathwise identifies the exact skills you're missing—not 20 things, just the essentials.",
  ...
  },
  {
    ...
    description: "A step-by-step path ordered from your current level to advanced mastery.",
...
function HowItWorks() {
  return (
    <section id="how-it-works" className="relative scroll-mt-20 py-24 overflow-hidden">
...
function FeatureCard({ title, description, subtext, icon, index }: any) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
